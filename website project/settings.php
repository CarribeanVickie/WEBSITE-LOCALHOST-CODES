...
$query = "SELECT * FROM userdetails WHERE email = '$admin_username' LIMIT 1";
...
<html lang="en">
    <head>
        ...
        <link href="styling/style1.css" rel="stylesheet" />
            ...
            <div id="layoutSidenav_nav">
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        ...
                        <h5 style="text-align: center;">Settings Panel,</h5> 
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                ...
                                <h1>SUPERIOR MOTOR LIMITED<span class="text-warning"><br> Profile User</span></h1>
                            </div>
                            <form>
