...
<head>
    ...
    <title>SUPERIOR MOTORS LTD</title>
</head>
<body>
    <!-- navbar -->
    <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 fixed-top">
        <div class="container">
            <a href="#" class="navbar-brand">Superior Motors Limited</a>
            ...
            <div class="collapse navbar-collapse" id="navmenu">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a href="#instructors" class="nav-link">MORTOCYCLES</a>
                    </li>
                    <li class="nav-item">
    ...
    <section class="bg-primary text-light p-5">
        <div class="container">
            ...
            align-items-center">
            <h3 class="mb-3 mb-md-0">Sign Up To Access our products</h3>
            ...
            <div class="input-group news-input">
                ...
                />
                <input
                class="btn btn-dark btn-md w-50 " 
                type="submit"
                name=""
                value="submit"
                >
    ...
    <section id="question" class="p-5">
        ...
        id="Questions">
            ...
            <div class="accordion-item">
                ...
                data-bs-parent="#Questions">
                  <div class="accordion-body">
                    Sign Up through the link on the Navigation Bar Above. once you sign Up it will Open a new user page
                    for you to access our devices.
                  </div>
                </div>
            </div>
